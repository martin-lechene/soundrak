class Pop2Music {
    ...
    setupLoops() {
        ...
        this.variationLoop = new Tone.Loop((time) => {
            // Pattern de variation pour les builds
    ...
    start() {
        ...
        this.arpLoop.start("4m"); // Arp commence après 4 mesures
    ...
    setVolume(level) {
        ...
        this.arp.volume.value = Tone.gainToDb(level * 0.6);
    }
