class HouseMusic {
    ...
    setupLoops() {
        // Kick pattern - 4/4 house
        this.kickLoop = new Tone.Loop((time) => {
            this.kick.triggerAttackRelease("C1", "4n", time);
        }, "4n");

        // Clap pattern - sur les 2 et 4
        this.clapLoop = new Tone.Loop((time) => {
            this.clap.triggerAttackRelease("4n", time);
        }, "2n");
    ...
    setVolume(level) {
        ...
        this.clap.volume.value = Tone.gainToDb(level * 0.7);
